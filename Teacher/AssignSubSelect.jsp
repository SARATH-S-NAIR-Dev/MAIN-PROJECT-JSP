        ...
        <section id="service" class="services-mf route">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <%
                        String select1= "select * from tbl_subject s inner join tbl_assign a on a.subject_id=s.subject_id where teacher_id='" + session.getAttribute("Teacherid") + "' and semester_id='" + request.getParameter("mid") + "' ";
                    ...
                    <div class="col-md-4">
                        <a href="Assignment.jsp?mid=<%=rs1.getString("subject_id")%>"> <div class="service-box">
                                <div class="service-ico">
                                    <span class="ico-circle"><i class="ion-android-document"></i></span>
                                </div>
                                <div class="service-content">
                                    <h2 class="s-title"><%=rs1.getString("subject_name")%></h2>
