...
<table id="example" class="display nowrap" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th>Student Name</th>
                            <%
                                String selQry = "select * from tbl_subject s inner join tbl_assign a on a.subject_id=s.subject_id where a.teacher_id='"+session.getAttribute("Teacherid")+"' and subject_status=0 and semester_id='" + request.getParameter("mid") + "'";
