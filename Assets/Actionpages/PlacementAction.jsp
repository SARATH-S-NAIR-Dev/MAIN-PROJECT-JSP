...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("file"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\placement\\";//path for storing image
           ...
           //to upload proof of doctor
                ...
                String InsQry = "insert into tbl_placement(placement_company,placement_proof,student_id)values('" + value[0] + "','" + proof + "','"+session.getAttribute("Studentid")+"')";
                out.println(InsQry);
   ...
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Student/Placement.jsp';
