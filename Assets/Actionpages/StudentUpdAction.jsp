...
<html>
    ...
    <body>
        ...
        <%
            ...
            String Upd = "update tbl_student set ";
...
//                        }
                ...
                //Strinh str1="insert into tbl_student ()";//inserting file
                Upd += "student_name='" + value[0] + "',student_contact='" + value[1] + "',student_email='" + value[2] + "',student_address='" + value[3] + "' where student_id='" + session.getAttribute("Studentid") + "'";
                out.println(Upd);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Student/StudentActionEdit.jsp';
