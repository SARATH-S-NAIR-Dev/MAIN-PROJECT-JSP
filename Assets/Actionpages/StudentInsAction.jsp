...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("photo"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\StudentPhoto\\";//path for storing image
                        ...
                        if (field_name.equals("proof"))//write the name of image here it is img_product
                        {
                            ...
                            //setting path to store image
                            File proj_path = new File(config.getServletContext().getRealPath("/"));
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\StudentProof\\";//path for storing image
                            Random r = new Random();//to generate random number
                            int r_num = r.nextInt(1111) + 999;//values between this are generated

                            proof = "studentproof_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                            //creating a file object
           ...
           //to upload proof of doctor
                ...
                String InsQry = "insert into tbl_student(student_name,student_contact,student_email,student_address,place_id,student_gender,student_photo,student_proof,student_password,student_year,student_regno,student_dob,student_aadhar,student_blood,student_admno,student_religion,student_category,student_guardno,student_roll)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[5] + "','" + value[6] + "','" + photo + "','" + proof + "','" + value[7] + "','" + value[9] + "','" + value[10] + "','" + value[11] + "','" + value[12] + "','" + value[13] + "','" + value[14] + "','" + value[15] + "','" + value[16] + "','" + value[17] + "','" + value[18] + "')";
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Teacher/Student.jsp';
