...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("photo"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\teacher\\TeacherPhoto\\";//path for storing image
                        ...
                        if (field_name.equals("proof"))//write the name of image here it is img_product
                        {
                            ...
                            //setting path to store image
                            File proj_path = new File(config.getServletContext().getRealPath("/"));
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\teacher\\TeacherProof\\";//path for storing image
                            Random r = new Random();//to generate random number
                            int r_num = r.nextInt(1111) + 999;//values between this are generated

                            proof = "teacherproof_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
                            //creating a file object
           ...
           //to upload proof of doctor
                ...
                String InsQry = "insert into tbl_teacher(teacher_name,teacher_contact,teacher_email,teacher_address,place_id,teacher_gender,teacher_photo,teacher_proof,teacher_password,teacher_qualification,teacher_doj)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','"+value[4]+"','" + value[5] + "','" + photo + "','" + proof + "','" + value[6] + "','" + value[8] + "',curdate())";
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Admin/TeacherRegIndex.jsp';
