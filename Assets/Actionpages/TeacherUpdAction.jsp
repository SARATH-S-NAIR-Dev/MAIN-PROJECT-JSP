...
<html>
    ...
    <body>
        ...
        <%
            ...
            String Upd = "update tbl_teacher set ";
            ...
            if (isMultipart) {
                ...
                while (itr.hasNext())//checking if there is any value in the position like rs.next()
                {
                    ...
                    if (f_item.isFormField()) {
                        ...
                        value[k] = f_item.getString();//teacher typing value
                    ...
                    } else//when it is an image or multipart
                    {
                        ...
                        if (!f_item.getName().equals("")) {
                            if (field_name.equals("photo"))//write the name of image here it is img_product
                            {
                                ...
                                String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\Teacher\\TeacherPhoto\\";//path for storing image
...
//                            //setting path to store image
//                            File proj_path = new File(config.getServletContext().getRealPath("/"));
//                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\teacherproof\\";//path for storing image
//                            Random r = new Random();//to generate random number
//                            int r_num = r.nextInt(1111) + 999;//values between this are generated
//
...
//                        }
                ...
                //Strinh str1="insert into tbl_teacher ()";//inserting file
                Upd += "teacher_name='" + value[0] + "',teacher_contact='" + value[1] + "',teacher_email='" + value[2] + "',teacher_address='" + value[3] + "' where teacher_id='" + session.getAttribute("Teacherid") + "'";
                out.println(Upd);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Teacher/TeacherActionEdit.jsp';
