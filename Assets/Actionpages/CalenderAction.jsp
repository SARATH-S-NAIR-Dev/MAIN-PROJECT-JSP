...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("file"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\Files\\CalenderPDF\\";//path for storing image
           ...
           //to upload proof of doctor
                ...
                String InsQry = "insert into tbl_calender(calender_date,calender_file,semester_id)values(curdate(),'" + photo + "','" + value[0] + "')";
                out.println(InsQry);
   ...
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Admin/Calender.jsp'
