...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Time Table Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    String select = "select * from tbl_timetable a inner join tbl_subject s on s.subject_id=a.subject_id inner join tbl_semester k on k.semester_id=s.semester_id";
            ...
            <tr>
                <td><%=i%></td>
                <td><%=resss.getString("timetable_day")%></td>
                <td><%=resss.getString("timetable_Hour")%></td>
                <td><%=resss.getString("semester_name")%></td>
                <td><%=resss.getString("subject_name")%></td>

                <td><a href="TimeTable.jsp?did=<%=resss.getString("timetable_id")%>">DELETE</a></td>
            </tr>
            <%
