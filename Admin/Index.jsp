...
<html lang="en">
    ...
    %>
    <body>
        <div class="bg-white d-flex pr-0 mr">

            <!-- Spinner End -->
            <%
                String selt = "select * from tbl_admin";
                ResultSet ps = con.selectCommand(selt);
                if( ps.next()) {
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    <a href="index.html" class="navbar-brand mx-4 mb-3">
                        <h3 class="text-primary"><i class=""></i>DASHBOARD</h3>
                    </a>
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="Calender.jsp" class="nav-item nav-link"><i class="fa fa-calendar"></i>Calender</a>
                        <a href="District.jsp" class="nav-item nav-link"><i class="fa fa-map"></i>District</a>
                        <a href="Place.jsp" class="nav-item nav-link"><i class="fa fa-location-arrow"></i>Place</a>
                        <a href="Semester.jsp" class="nav-item nav-link"><i class="fa fa-address-card"></i>Semester</a>
                        <a href="Subject.jsp" class="nav-item nav-link"><i class="fas fa-book-open"></i>Subject</a>
                        <a href="semexam.jsp" class="nav-item nav-link"><i class="fas fa-book-open"></i>Add Results</a>
                        <a href="Notification.jsp" class="nav-item nav-link"><i class="fa fa-bell"></i>Notification</a>
                        <div class="navbar-nav w-100">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-transparent border-0">
                                    ...
                                    <a href="TeacherRegIndex.jsp" class="dropdown-item"><i class="fa fa-users"></i> Add Teachers</a>
                                    <a href="TeacherAssign.jsp" class="dropdown-item"><i class="fa fa-tasks"></i> Assign Teachers</a>
                                    <a href="TeacherView.jsp" class="dropdown-item"><i class="fa fa-eye"></i> View Teachers</a>

                                </div>
                            </div>

                            <a href="TimeTable.jsp" class="nav-item nav-link"><i class="fa fa-chart-bar"></i>Timetable</a>
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-light text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0">Recently Added Teachers</h6>
                            <a href="">Show All</a>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-4">
                            <div class="h-100 bg-light rounded p-4">
                                ...
                                <%                                    if (request.getParameter("submit") != null) {
                                        String INS = "insert into tbl_todo(todo_content) values ('" + request.getParameter("todo") + "')";
                                ...
                                <div class="d-flex mb-2">
                                    ...
                                    <input type="button" name="submit" value="submit" class="btn btn-primary ms-2">

                                </div>
                                <%                                     String SEL = "select * from tbl_todo";
                                ...
                                <div class="d-flex align-items-center border-bottom py-2">
                                    ...
                                    <div class="w-100 ms-3">
                                        <div class="d-flex w-100 align-items-center justify-content-between">
                                            <span><%=ks.getString("todo_content")%></span>
