...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <!--/ Nav Star /-->
        <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" style="background: white"  id="mainNav" >
            <div class="container">
                <a class="navbar-brand js-scroll" href="../Assets/Template/Temp/#page-top"style="color: #0078ff"  >MCA </a>
                        ...
                        <li>
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" style="color: #0078ff"  class="nav-link dropdown-toggle dropbtn" data-bs-toggle="dropdown">
                                    <i class="fa fa-bell me-lg-2" style="color: #0078ff" ></i>
                                    <span class="d-none d-lg-inline-flex"style="color: #0078ff" >Notification</span>
                                </a>
                                <div class="dropdown-menu dropdown-content dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0" style="color: #0078ff" >
