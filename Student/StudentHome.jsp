    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top"  id="mainNav" >
            <div class="container">
                ...
                <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link js-scroll active"  href="StudentHome.jsp">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link js-scroll"  href="StudentProfile.jsp">Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link js-scroll"  href="StudentActionEdit.jsp">Edit Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link js-scroll"  href="StudentChangePassword.jsp">Change Password</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link js-scroll"  href="TableView.jsp">Timetable</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="navbar-nav align-items-center ms-auto">
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-content dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                                        ...
                                        %>
                                        <a href="viewnoti.jsp?id=<%=rs.getString("notification_id")%>" class="dropdown-item">
        ...
        <section id="service" class="services-mf route">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <a href="StudentProfile.jsp"> <div class="service-box">
                    ...
                    <div class="col-md-4">
                        <a href="peer.jsp"><div class="service-box">
                                <div class="service-ico">
                                    <span class="ico-circle"><i class="ion-chatbox"></i></span>
                                </div>
                                <div class="service-content">
                    ...
                    <div class="col-md-4">
                        <a href="StudentActionEdit.jsp"> <div class="service-box">
                                <div class="service-ico">
                    ...
                    <div class="col-md-4">
                        <div class="service-box">
                            <a href="StudentChangePassword.jsp"> <div class="service-ico">
                    ...
                    <div class="col-md-4">
                        <a href="TableView.jsp"><div class="service-box">
                                <div class="service-ico">
                    ...
                    <div class="col-md-4">
                        <a href="SubmittedAssign.jsp">  <div class="service-box">
                                <div class="service-ico">
                                    <span class="ico-circle"><i class="ion-stats-bars"></i></span>
                                </div>
                                <div class="service-content">
                                    <h2 class="s-title">Assignment Marks</h2>  
                                    <p class="s-description text-center">
                    ...
                    <div class="col-md-4">
                        <a href="SemMark.jsp">  <div class="service-box">
                                <div class="service-ico">
                                    <span class="ico-circle"><i class="ion-android-folder"></i></span>
                                </div>
                                <div class="service-content">
                                    <h2 class="s-title">View Semester Results</h2>  
                                    <p class="s-description text-center">
                    ...
                    <div class="col-md-4">
                        <a href="Placement.jsp">  <div class="service-box">
                                <div class="service-ico">
                                    <span class="ico-circle"><i class="ion-stats-bars"></i></span>
                                </div>
                                <div class="service-content">
                                    <h2 class="s-title">Add Placements</h2>  
                                    <p class="s-description text-center">
                    ...
                    <div class="col-md-4">
                        <a href="ViewAssignment.jsp">  <div class="service-box">
                                <div class="service-ico">
                                    <span class="ico-circle"><i class="ion-stats-bars"></i></span>
                                </div>
                                <div class="service-content">
