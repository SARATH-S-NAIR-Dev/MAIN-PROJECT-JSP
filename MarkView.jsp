    ...
    <body>
        ...
        <table width="100%" height="100%">
            ...
            <%
                ...
                String select1 = "select * from tbl_mark m inner join tbl_subject s on m.subject_id=s.subject_id where  student_id='"+request.getParameter("sid")+"' and s.semester_id='"+request.getParameter("mid")+"' and subject_status=0";
               // out.println(select1);
